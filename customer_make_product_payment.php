...
{
	extract($_POST);
	echo $q="INSERT INTO `payment` VALUES(NULL,'$oid','omaster','$total',NOW())";
	insert($q);
	$q1="update order_master set status='paid' where omaster_id='$oid'";
	update($q1);
	alert("Payment success");
	return redirect("customer_make_product_payment.php?total=$total");
}
?>
...
<table class="table" style="width: 600px;background-color: rgb(200,100,100,0.4);">
	...
	<tr>
		...
		<td><input type="text" name="amt" required="" value="<?php echo $total ?>" class="form-control"></td>
	</tr>
	<tr>
